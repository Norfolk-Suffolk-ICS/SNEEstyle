...
## {.fig background-color="#C0CED8" background-image="SNEE_IF_background.png" background-position="left" background-size="contain"}

![](SNEE_IF_logo.png){.nostretch fig-align="right" width="600"}
